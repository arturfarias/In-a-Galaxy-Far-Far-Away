...
urlpatterns = [
    ...
    url(r'^central/perfil/editar/$', views.editar,name = "editar"), #tela de editar usuario
    url(r'^central/perfil/senha/$', views.trocarsenha,name = "trocarsenha"), #tela de mudar senha
]
